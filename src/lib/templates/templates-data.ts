...
export const TEMPLATES: Template[] = [
  ...
  // ── Batch 2: Client-base-aligned templates ────────────────────────────────────
  {
  ...
  },
  {
    ...
    description: "Vibrant painting & decorating company. Bright white + purple accent. Before/after gallery, colour consultation CTA, fast quote flow.",
    tags: ["painting", "decorating", "interior", "colour", "residential"],
    gradient: "from-violet-500 to-pink-500", accentColor: "violet", accentColorHex: "#7c3aed",
    primaryColor: "#7c3aed", secondaryColor: "#db2777",
    thumbFrom: "#7c3aed", thumbTo: "#be185d",
    heroImage: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=600&q=80&fit=crop",
    pages: 6, hasDemo: true,
  ...
  },
  {
    ...
    description: "Authoritative pest control. Deep green palette. Treatment types, NEA certification, eco-safe badges, residential & commercial contracts.",
    tags: ["pest control", "termite", "extermination", "residential", "commercial"],
    gradient: "from-green-700 to-emerald-800", accentColor: "green", accentColorHex: "#15803d",
    primaryColor: "#15803d", secondaryColor: "#166534",
    thumbFrom: "#14532d", thumbTo: "#166534",
    ...
    heroSubline: "Licensed pest management. Safe for kids & pets.",
  },
  {
    id: "tpl-059", slug: "uniform-pro", name: "UniformPro", category: "Retail & Shop",
    description: "Professional garment & uniform supplier. Navy + gold. Product showcase, bulk order form, fabric specs, corporate client testimonials.",
    tags: ["uniforms", "garments", "workwear", "corporate", "embroidery"],
    gradient: "from-blue-900 to-yellow-700", accentColor: "blue", accentColorHex: "#1e3a5f",
    primaryColor: "#1e3a5f", secondaryColor: "#c9a84c",
    thumbFrom: "#1e3a5f", thumbTo: "#92400e",
    heroImage: "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=600&q=80&fit=crop",
    pages: 6, hasDemo: true,
    heroHeadline: "Uniforms That Represent Your Brand",
    heroSubline: "Custom workwear for corporate, F&B, healthcare & industrial. MOQ 10.",
  },
  {

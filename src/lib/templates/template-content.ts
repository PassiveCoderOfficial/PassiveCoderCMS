...
const CONTENT: Record<string, TemplateContent> = {
  ...
  "cool-breeze": {
    ...
    services: [
      { name: "AC Installation", desc: "Split, multi-split and cassette systems. Daikin, Mitsubishi, Panasonic authorised installer.", price: "From $480/unit", icon: "❄️" },
      { name: "AC Servicing", desc: "General servicing, filter cleaning, gas top-up and leak checks. Quarterly contracts available.", price: "From $40/unit", icon: "🔧" },
      { name: "Chemical Wash", desc: "Deep chemical cleaning to remove mould, bacteria and buildup. Restores cooling efficiency.", price: "From $80/unit", icon: "🧪" },
      { name: "Ducted Central HVAC", desc: "Design, supply and installation of central ducted systems for offices, retail and hotels.", price: "Request Quote", icon: "🏢" },
      { name: "Emergency Repair", desc: "24/7 emergency AC repair for all brands. Most faults resolved on first visit.", price: "From $120", icon: "🚨" },
      { name: "Annual Maintenance Contract", desc: "Quarterly servicing, priority emergency response, free parts and one chemical wash per year.", price: "From $180/unit/yr", icon: "📋" },
    ],
    about: {
  ...
  "sparky-pro": {
    ...
    services: [
      { name: "Electrical Wiring & Rewiring", desc: "New wiring and full rewiring to SS 638 standards. Certified by our Licensed Electrical Worker.", price: "From $150", icon: "⚡" },
      { name: "DB Box Upgrade", desc: "Replace old fuse boards with modern MCB distribution boards with earth leakage protection.", price: "From $380", icon: "🔌" },
      { name: "Lighting Installation", desc: "LED downlights, track lighting, pendant and smart lighting. Residential and commercial.", price: "From $25/point", icon: "💡" },
      { name: "Plumbing Repair", desc: "Tap, toilet, sink, shower and water heater repairs and new installations.", price: "From $80", icon: "🔩" },
      { name: "Pipe Replacement", desc: "Replace ageing galvanised pipes with modern PEX or CPVC. Reduce leaks and pressure loss.", price: "From $200", icon: "🪛" },
      { name: "Commercial Works", desc: "Complete electrical and M&E services for offices, retail, F&B and industrial units.", price: "Request Quote", icon: "🏭" },
    ],
    about: {
  ...
  "fresh-wash": {
    ...
    services: [
      { name: "Wash & Fold", desc: "Machine wash, tumble dry and neatly folded. Eco-friendly detergent. Sorted by colour and fabric.", price: "From $1.80/kg", icon: "👕" },
      { name: "Dry Cleaning", desc: "Specialist solvent cleaning for suits, dresses, delicates, leather and formal wear.", price: "From $8/item", icon: "🥼" },
      { name: "Ironing & Pressing", desc: "Professional steam ironing for shirts, pants, dresses and uniforms.", price: "From $1.50/item", icon: "👔" },
      { name: "Sneaker Cleaning", desc: "Deep clean, deodorising and re-whitening for all sneaker types. Sole restoration included.", price: "From $18/pair", icon: "👟" },
      { name: "Curtain & Linen Cleaning", desc: "Full curtain cleaning, duvets, pillows and all bed linen accepted.", price: "From $12/panel", icon: "🛏️" },
      { name: "Express Service", desc: "12-hour turnaround for urgent items. Available 7 days. Priority cleaning and delivery.", price: "+50% on standard rate", icon: "⚡" },
    ],
    about: {
  ...
  "curtain-studio": {
    ...
    services: [
      { name: "Curtains & Drapes", desc: "Eyelet, pinch pleat, wave and tab-top curtains in sheer, semi-sheer and blackout fabrics.", price: "From $80/panel", icon: "🪟" },
      { name: "Roman & Roller Blinds", desc: "Clean, contemporary blinds in hundreds of fabrics — daylight, blackout, moisture-resistant options.", price: "From $120/window", icon: "🔲" },
      { name: "Motorised & Smart Blinds", desc: "App-controlled, voice-activated or scene-triggered blinds. Google Home, Alexa and KNX compatible.", price: "From $280/window", icon: "📱" },
      { name: "Commercial & Hospitality", desc: "High-volume supply and installation for hotels, offices and serviced apartments. Contract pricing.", price: "Request Quote", icon: "🏨" },
      { name: "Carpets & Rugs", desc: "Broadloom carpets, carpet tiles and handmade rugs in custom sizes and colours.", price: "From $5/sqft", icon: "🪵" },
      { name: "Upholstery", desc: "Sofa reupholstery, cushion covers, headboards and custom fabric accessories.", price: "From $150/piece", icon: "🛋️" },
    ],
    about: {
  ...
  "trade-supply": {
    ...
    services: [
      { name: "Wholesale Supply", desc: "Bulk supply of consumer goods, building materials, chemicals, food commodities and industrial products.", price: "MOQ Pricing", icon: "📦" },
      { name: "Import & Export", desc: "Full documentation, customs clearance and compliance for cross-border trade across Asia and the Gulf.", price: "Contact for Rates", icon: "🚢" },
      { name: "Global Sourcing", desc: "Manufacturer identification, factory audits, sample management and production oversight in BD, India, CN, VN.", price: "From 3% of order", icon: "🌏" },
      { name: "Freight & Logistics", desc: "FCL and LCL ocean freight, air freight, inland trucking and last-mile delivery across GCC and ASEAN.", price: "Quote on enquiry", icon: "✈️" },
      { name: "Quality Control", desc: "Pre-shipment inspection, in-line QC and lab testing through certified inspection companies.", price: "From $250/inspection", icon: "✅" },
      { name: "Brand Distribution", desc: "Exclusive and non-exclusive distribution agreements for brands entering GCC and ASEAN markets.", price: "Partnership basis", icon: "🤝" },
    ],
    about: {

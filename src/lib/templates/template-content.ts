...
const CONTENT: Record<string, TemplateContent> = {
  ...
  "build-right": {
    ...
    services: [
      { name: "Full Home Renovation", desc: "Complete HDB or condo overhaul — carpentry, tiling, electrical, plumbing and painting. Turnkey delivery.", price: "From $18,000", icon: "🏠", image: "https://images.unsplash.com/photo-1484154218962-a197022b5858?w=600&q=80&fit=crop" },
      { name: "Commercial Fitout", desc: "Office, retail, F&B and co-working spaces built to spec. We manage permits.", price: "Request Quote", icon: "🏢", image: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600&q=80&fit=crop" },
      { name: "Kitchen Remodel", desc: "Custom carpentry, hob, hood and sink installation. Full tiling and waterproofing.", price: "From $6,500", icon: "🍳", image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&q=80&fit=crop" },
      { name: "Bathroom Renovation", desc: "Waterproofing, tiling, sanitary fitting, mirror cabinet and lighting.", price: "From $4,200", icon: "🚿", image: "https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?w=600&q=80&fit=crop" },
      { name: "Carpentry & Wardrobes", desc: "Full custom carpentry — platform beds, wardrobes, TV consoles. E0 board standard.", price: "From $1,800", icon: "🪵", image: "https://images.unsplash.com/photo-1558997519-83ea9252edf8?w=600&q=80&fit=crop" },
      { name: "Hacking & Demolition", desc: "Wall hacking, floor hacking and structural opening works. HDB-approved.", price: "From $800", icon: "⚒️", image: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "colour-craft": {
    ...
    services: [
      { name: "Interior House Painting", desc: "Full interior repaint for HDB, condo or landed — walls, ceilings, doors and trim.", price: "From $380 (3-room)", icon: "🏠", image: "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=600&q=80&fit=crop" },
      { name: "Feature Wall Painting", desc: "Accent walls, geometric patterns, ombre effects and decorative finishes.", price: "From $180/wall", icon: "🎨", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80&fit=crop" },
      { name: "Exterior Painting", desc: "HDB block touch-up, landed exterior and metal gates. Weatherproof paint.", price: "From $800", icon: "🏗️", image: "https://images.unsplash.com/photo-1558618047-f4e71a7f6e47?w=600&q=80&fit=crop" },
      { name: "Commercial Repainting", desc: "Office, retail, restaurant repainting. Weekend and after-hours slots.", price: "Request Quote", icon: "🏢", image: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600&q=80&fit=crop" },
      { name: "Wallpaper Installation", desc: "Supply and install wallpaper, murals and vinyl wall decals.", price: "From $8/sqft", icon: "🖼️", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&q=80&fit=crop" },
      { name: "Texture & Specialty Finishes", desc: "Sand texture, marble effect, lime wash and decorative wall coatings.", price: "From $12/sqft", icon: "✨", image: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "pest-shield": {
    ...
    services: [
      { name: "General Pest Control", desc: "Treatment for cockroaches, ants, flies and common household insects.", price: "From $80/treatment", icon: "🐛", image: "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=600&q=80&fit=crop" },
      { name: "Termite Treatment", desc: "Soil treatment, baiting systems and structural pre-treatment. 5-year warranty.", price: "From $350", icon: "🪲", image: "https://images.unsplash.com/photo-1508739773434-c26b3d09e071?w=600&q=80&fit=crop" },
      { name: "Rodent Control", desc: "Rat and mouse elimination using tamper-resistant bait stations. Monthly monitoring.", price: "From $180", icon: "🐀", image: "https://images.unsplash.com/photo-1615655406736-b37887a35122?w=600&q=80&fit=crop" },
      { name: "Bed Bug Treatment", desc: "Heat treatment and chemical residual treatment. 3-month warranty.", price: "From $280", icon: "🛏️", image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&q=80&fit=crop" },
      { name: "Mosquito Control & Fogging", desc: "ULV thermal fogging, larviciding and misting systems.", price: "From $120", icon: "🦟", image: "https://images.unsplash.com/photo-1558522195-e1201b090344?w=600&q=80&fit=crop" },
      { name: "Commercial Contracts", desc: "NEA-compliant annual pest management for F&B, hospitality and healthcare.", price: "From $800/year", icon: "🏢", image: "https://images.unsplash.com/photo-1466611653911-95081537e5b7?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "uniform-pro": {
    ...
    services: [
      { name: "Corporate Uniforms", desc: "Polo shirts, formal shirts, trousers and blazers with your logo. MOQ 20 pcs.", price: "From $8/piece", icon: "👔", image: "https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=600&q=80&fit=crop" },
      { name: "F&B & Hospitality Wear", desc: "Chef coats, aprons, server uniforms. Stain-resistant and easy-care fabrics.", price: "From $6/piece", icon: "🧑‍🍳", image: "https://images.unsplash.com/photo-1577219491135-ce391730fb2c?w=600&q=80&fit=crop" },
      { name: "Healthcare & Medical", desc: "Scrubs, lab coats, nursing uniforms. Anti-microbial fabric options available.", price: "From $10/piece", icon: "🏥", image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=600&q=80&fit=crop" },
      { name: "Industrial Workwear", desc: "High-visibility vests, coveralls and PPE-compliant workwear.", price: "From $12/piece", icon: "🦺", image: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=600&q=80&fit=crop" },
      { name: "School & Sports Uniforms", desc: "School uniforms, PE kits, team jerseys and sports apparel.", price: "From $5/piece", icon: "🎒", image: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=600&q=80&fit=crop" },
      { name: "Embroidery & Printing", desc: "Logo embroidery, screen printing, heat transfer and sublimation.", price: "From $2/piece", icon: "🪡", image: "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "glass-line": {
    ...
    services: [
      { name: "Glass Partitions", desc: "Frameless, semi-frameless and framed glass partition systems. Any glass type.", price: "From $80/sqft", icon: "🪟", image: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=600&q=80&fit=crop" },
      { name: "Aluminium Windows & Doors", desc: "Casement, sliding, awning and bi-fold aluminium windows and doors.", price: "From $120/panel", icon: "🚪", image: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80&fit=crop" },
      { name: "Roller Shutters", desc: "Manual and motorised aluminium roller shutters for shops, warehouses and garages.", price: "From $800/opening", icon: "🏭", image: "https://images.unsplash.com/photo-1601933973783-43cf8a7d4c5f?w=600&q=80&fit=crop" },
      { name: "Frameless Glass Doors", desc: "Tempered and laminated frameless glass doors with floor spring or pivot fitting.", price: "From $600/door", icon: "🔲", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80&fit=crop" },
      { name: "Curtain Wall Systems", desc: "Unitised and stick-built aluminium curtain wall for commercial developments.", price: "Request Quote", icon: "🏙️", image: "https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&q=80&fit=crop" },
      { name: "Glass Balustrades", desc: "Tempered glass balustrades for staircases, balconies and pool surrounds.", price: "From $150/lm", icon: "🪜", image: "https://images.unsplash.com/photo-1545558014-8692077e9b5c?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "cool-breeze": {
    ...
    services: [
      { name: "AC Installation", desc: "Split, multi-split and cassette systems. Daikin, Mitsubishi, Panasonic authorised installer.", price: "From $480/unit", icon: "❄️", image: "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600&q=80&fit=crop" },
      { name: "AC Servicing", desc: "General servicing, filter cleaning, gas top-up and leak checks. Quarterly contracts available.", price: "From $40/unit", icon: "🔧", image: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=600&q=80&fit=crop" },
      { name: "Chemical Wash", desc: "Deep chemical cleaning to remove mould, bacteria and buildup. Restores cooling efficiency.", price: "From $80/unit", icon: "🧪", image: "https://images.unsplash.com/photo-1581092921461-39b9d08a9b21?w=600&q=80&fit=crop" },
      { name: "Ducted Central HVAC", desc: "Design, supply and installation of central ducted systems for offices, retail and hotels.", price: "Request Quote", icon: "🏢", image: "https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=600&q=80&fit=crop" },
      { name: "Emergency Repair", desc: "24/7 emergency AC repair for all brands. Most faults resolved on first visit.", price: "From $120", icon: "🚨", image: "https://images.unsplash.com/photo-1558522195-e1201b090344?w=600&q=80&fit=crop" },
      { name: "Annual Maintenance Contract", desc: "Quarterly servicing, priority emergency response, free parts and one chemical wash per year.", price: "From $180/unit/yr", icon: "📋", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "sparky-pro": {
    ...
    services: [
      { name: "Electrical Wiring & Rewiring", desc: "New wiring and full rewiring to SS 638 standards. Certified by our Licensed Electrical Worker.", price: "From $150", icon: "⚡", image: "https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=600&q=80&fit=crop" },
      { name: "DB Box Upgrade", desc: "Replace old fuse boards with modern MCB distribution boards with earth leakage protection.", price: "From $380", icon: "🔌", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80&fit=crop" },
      { name: "Lighting Installation", desc: "LED downlights, track lighting, pendant and smart lighting. Residential and commercial.", price: "From $25/point", icon: "💡", image: "https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=600&q=80&fit=crop" },
      { name: "Plumbing Repair", desc: "Tap, toilet, sink, shower and water heater repairs and new installations.", price: "From $80", icon: "🔩", image: "https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=600&q=80&fit=crop" },
      { name: "Pipe Replacement", desc: "Replace ageing galvanised pipes with modern PEX or CPVC. Reduce leaks and pressure loss.", price: "From $200", icon: "🪛", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=600&q=80&fit=crop" },
      { name: "Commercial Works", desc: "Complete electrical and M&E services for offices, retail, F&B and industrial units.", price: "Request Quote", icon: "🏭", image: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "fresh-wash": {
    ...
    services: [
      { name: "Wash & Fold", desc: "Machine wash, tumble dry and neatly folded. Eco-friendly detergent. Sorted by colour and fabric.", price: "From $1.80/kg", icon: "👕", image: "https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=600&q=80&fit=crop" },
      { name: "Dry Cleaning", desc: "Specialist solvent cleaning for suits, dresses, delicates, leather and formal wear.", price: "From $8/item", icon: "🥼", image: "https://images.unsplash.com/photo-1489987707025-afc232f7ea0f?w=600&q=80&fit=crop" },
      { name: "Ironing & Pressing", desc: "Professional steam ironing for shirts, pants, dresses and uniforms.", price: "From $1.50/item", icon: "👔", image: "https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=600&q=80&fit=crop" },
      { name: "Sneaker Cleaning", desc: "Deep clean, deodorising and re-whitening for all sneaker types. Sole restoration included.", price: "From $18/pair", icon: "👟", image: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600&q=80&fit=crop" },
      { name: "Curtain & Linen Cleaning", desc: "Full curtain cleaning, duvets, pillows and all bed linen accepted.", price: "From $12/panel", icon: "🛏️", image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&q=80&fit=crop" },
      { name: "Express Service", desc: "12-hour turnaround for urgent items. Available 7 days. Priority cleaning and delivery.", price: "+50% on standard rate", icon: "⚡", image: "https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "curtain-studio": {
    ...
    services: [
      { name: "Curtains & Drapes", desc: "Eyelet, pinch pleat, wave and tab-top curtains in sheer, semi-sheer and blackout fabrics.", price: "From $80/panel", icon: "🪟", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80&fit=crop" },
      { name: "Roman & Roller Blinds", desc: "Clean, contemporary blinds in hundreds of fabrics — daylight, blackout, moisture-resistant options.", price: "From $120/window", icon: "🔲", image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=600&q=80&fit=crop" },
      { name: "Motorised & Smart Blinds", desc: "App-controlled, voice-activated or scene-triggered blinds. Google Home, Alexa and KNX compatible.", price: "From $280/window", icon: "📱", image: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=600&q=80&fit=crop" },
      { name: "Commercial & Hospitality", desc: "High-volume supply and installation for hotels, offices and serviced apartments. Contract pricing.", price: "Request Quote", icon: "🏨", image: "https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&q=80&fit=crop" },
      { name: "Carpets & Rugs", desc: "Broadloom carpets, carpet tiles and handmade rugs in custom sizes and colours.", price: "From $5/sqft", icon: "🪵", image: "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=600&q=80&fit=crop" },
      { name: "Upholstery", desc: "Sofa reupholstery, cushion covers, headboards and custom fabric accessories.", price: "From $150/piece", icon: "🛋️", image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "shield-guard": {
    ...
    services: [
      { name: "Uniformed Guard Services", desc: "Trained, uniformed security officers for commercial premises, industrial sites and residential developments.", price: "From $18/hr", icon: "🛡️", image: "https://images.unsplash.com/photo-1557597774-9d273605dfa9?w=600&q=80&fit=crop" },
      { name: "CCTV & Surveillance", desc: "Installation, monitoring and management of IP-based CCTV systems with remote access and analytics.", price: "From $1,200", icon: "📹", image: "https://images.unsplash.com/photo-1590935217281-8f102120d683?w=600&q=80&fit=crop" },
      { name: "Mobile Patrol", desc: "Regular scheduled and random patrols of your premises by vehicle-mounted officers.", price: "From $800/mo", icon: "🚔", image: "https://images.unsplash.com/photo-1503596476-1c12a8ba09a9?w=600&q=80&fit=crop" },
      { name: "Event Security", desc: "Crowd management, access control and VIP protection for concerts, conferences and private events.", price: "Custom quote", icon: "🎪", image: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=600&q=80&fit=crop" },
      { name: "Executive Protection", desc: "Close-protection officers for high-net-worth individuals, corporate executives and visiting dignitaries.", price: "Custom quote", icon: "👤", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80&fit=crop" },
      { name: "Access Control Systems", desc: "Biometric, card-swipe and visitor management solutions integrated with your existing infrastructure.", price: "From $2,500", icon: "🔐", image: "https://images.unsplash.com/photo-1542621334-a254cf47733d?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "shine-auto": {
    ...
    services: [
      { name: "Express Wash", desc: "Exterior hand wash, tyre dressing, glass clean and interior wipe-down. In and out in 45 minutes.", price: "From $35", icon: "🚿", image: "https://images.unsplash.com/photo-1520340356584-f9917d1eea6f?w=600&q=80&fit=crop" },
      { name: "Full Detail", desc: "Interior vacuum, steam clean, leather condition, exterior wash, clay bar decontamination and machine polish.", price: "From $180", icon: "✨", image: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=600&q=80&fit=crop" },
      { name: "Ceramic Coating", desc: "Professional-grade 9H ceramic coating. 3–5 year protection. Hydrophobic, scratch-resistant, showroom shine.", price: "From $800", icon: "🛡️", image: "https://images.unsplash.com/photo-1552519507-da3b142c6e3d?w=600&q=80&fit=crop" },
      { name: "Paint Protection Film", desc: "Virtually invisible TPU film shields bumper, bonnet and mirrors from stone chips, scratches and abrasions.", price: "From $1,500", icon: "🎯", image: "https://images.unsplash.com/photo-1544636331-e26879cd4d9b?w=600&q=80&fit=crop" },
      { name: "Engine Bay Clean", desc: "Degreaser, rinse and dress engine bay components for improved aesthetics and easier maintenance.", price: "From $80", icon: "⚙️", image: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&q=80&fit=crop" },
      { name: "Headlight Restoration", desc: "Restore faded, yellowed headlights to factory clarity. Improves safety and kerb appeal.", price: "From $120", icon: "💡", image: "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "feast-events": {
    ...
    services: [
      { name: "Corporate Buffet", desc: "Professional buffet catering for conferences, seminars, product launches and office events. Live stations available.", price: "From $28/pax", icon: "🍽️", image: "https://images.unsplash.com/photo-1555244162-803834f70033?w=600&q=80&fit=crop" },
      { name: "Wedding Banquet", desc: "Full-service wedding catering from cocktail reception to multi-course dinner. Customised menus to your theme.", price: "From $88/pax", icon: "💒", image: "https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=600&q=80&fit=crop" },
      { name: "Private Dining", desc: "Intimate chef's table experiences, birthday dinners and VIP private events with dedicated sommelier service.", price: "From $120/pax", icon: "🥂", image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=600&q=80&fit=crop" },
      { name: "Food Truck & Street Food", desc: "Our branded food trucks deliver high-quality street food at festivals, markets and outdoor activations.", price: "From $4,500/day", icon: "🚚", image: "https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=600&q=80&fit=crop" },
      { name: "High Tea & Brunch", desc: "Curated high tea and brunch spreads for baby showers, engagement parties and corporate hosting.", price: "From $45/pax", icon: "🫖", image: "https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=600&q=80&fit=crop" },
      { name: "Live Cooking Stations", desc: "Chef-manned carving, wok, pasta and sushi live stations — perfect centrepiece for gala dinners and exhibitions.", price: "From $800/station", icon: "👨‍🍳", image: "https://images.unsplash.com/photo-1577219491135-ce391730fb2c?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "medplus-clinic": {
    ...
    services: [
      { name: "General Practice", desc: "Walk-in and appointment GP consultations for acute illness, chronic disease management and medical certificates.", price: "From $35", icon: "🩺", image: "https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=600&q=80&fit=crop" },
      { name: "Health Screening", desc: "Comprehensive health screenings including blood panel, ECG, body composition, vision and hearing checks.", price: "From $98", icon: "🔬", image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=600&q=80&fit=crop" },
      { name: "Vaccinations", desc: "Adult and child vaccinations including flu, HPV, Hepatitis B, travel vaccines and pre-employment jabs.", price: "From $28", icon: "💉", image: "https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=600&q=80&fit=crop" },
      { name: "Women's Health", desc: "Pap smear, breast examination, pre-natal care, contraception counselling and menopause management.", price: "From $80", icon: "🌸", image: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=600&q=80&fit=crop" },
      { name: "Chronic Disease Management", desc: "Long-term care plans for diabetes, hypertension, high cholesterol and asthma under CHAS and CDMP schemes.", price: "Subsidised rates", icon: "💊", image: "https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=600&q=80&fit=crop" },
      { name: "Minor Surgery", desc: "Wound suturing, mole and skin tag removal, abscess drainage and ingrown toenail procedures.", price: "From $150", icon: "🩹", image: "https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "drive-academy": {
    ...
    services: [
      { name: "Class 3A (Auto) Private Lessons", desc: "One-on-one circuit and road lessons in automatic transmission cars. Flexible morning, afternoon and weekend slots.", price: "From $65/lesson", icon: "🚗", image: "https://images.unsplash.com/photo-1546768292-fb12f6c92568?w=600&q=80&fit=crop" },
      { name: "Class 3 (Manual) Private Lessons", desc: "Manual transmission lessons for drivers seeking full licence flexibility. Ideal for commercial or overseas driving.", price: "From $65/lesson", icon: "⚙️", image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=600&q=80&fit=crop" },
      { name: "Intensive Course", desc: "Full-package intensive programme: 20 lessons + 2 theory sessions + 1 mock test. Average completion in 8 weeks.", price: "$1,200 package", icon: "⚡", image: "https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=600&q=80&fit=crop" },
      { name: "Refresher Course", desc: "For lapsed drivers returning after a break. Re-familiarise with current road rules and modern vehicle systems.", price: "From $65/lesson", icon: "🔄", image: "https://images.unsplash.com/photo-1502877338535-766e1452684a?w=600&q=80&fit=crop" },
      { name: "Theory Test Prep", desc: "Classroom and online preparation for Basic Theory Test (BTT) and Final Theory Test (FTT). 98% pass rate.", price: "$80 package", icon: "📚", image: "https://images.unsplash.com/photo-1434030216411-0b793f4b6753?w=600&q=80&fit=crop" },
      { name: "Simulator Training", desc: "Advanced driving simulator sessions covering wet weather, night driving and emergency stopping situations.", price: "From $45/session", icon: "🖥️", image: "https://images.unsplash.com/photo-1527515545081-5db817172677?w=600&q=80&fit=crop" },
    ],
    about: {
  ...
  "trade-supply": {
    ...
    services: [
      { name: "Wholesale Supply", desc: "Bulk supply of consumer goods, building materials, chemicals, food commodities and industrial products.", price: "MOQ Pricing", icon: "📦", image: "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&q=80&fit=crop" },
      { name: "Import & Export", desc: "Full documentation, customs clearance and compliance for cross-border trade across Asia and the Gulf.", price: "Contact for Rates", icon: "🚢", image: "https://images.unsplash.com/photo-1494412552100-42e4e7a74ec6?w=600&q=80&fit=crop" },
      { name: "Global Sourcing", desc: "Manufacturer identification, factory audits, sample management and production oversight in BD, India, CN, VN.", price: "From 3% of order", icon: "🌏", image: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?w=600&q=80&fit=crop" },
      { name: "Freight & Logistics", desc: "FCL and LCL ocean freight, air freight, inland trucking and last-mile delivery across GCC and ASEAN.", price: "Quote on enquiry", icon: "✈️", image: "https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=600&q=80&fit=crop" },
      { name: "Quality Control", desc: "Pre-shipment inspection, in-line QC and lab testing through certified inspection companies.", price: "From $250/inspection", icon: "✅", image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?w=600&q=80&fit=crop" },
      { name: "Brand Distribution", desc: "Exclusive and non-exclusive distribution agreements for brands entering GCC and ASEAN markets.", price: "Partnership basis", icon: "🤝", image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=600&q=80&fit=crop" },
    ],
    about: {

  ...
  return (
    <section className="py-24 relative overflow-hidden bg-[#05060a] border-t border-white/[0.05]">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-orange-600/15 rounded-full blur-[120px]" />
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="flex justify-center mb-6">
          <span className="inline-flex items-center gap-2 bg-white/[0.06] border border-white/[0.08] text-orange-300 text-xs font-semibold px-4 py-2 rounded-full">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-10">
          <Link
            ...
            className="group inline-flex items-center gap-2 bg-white hover:bg-slate-100 text-slate-950 font-semibold px-10 py-4 rounded-xl shadow-2xl shadow-orange-950/40 transition-all hover:scale-[1.02] text-base"
          >
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mt-8 text-sm text-slate-500">
          ...
          <span className="flex items-center gap-1.5"><Clock className="w-4 h-4 text-amber-400" /> Live in 24 hours</span>
          <span className="flex items-center gap-1.5"><Shield className="w-4 h-4 text-rose-400" /> Cancel anytime</span>
        </div>

    ...
    <div className="p-6 max-w-4xl space-y-8">
      ...
      <section className="bg-gray-900 border border-gray-800 rounded-xl p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-xs text-gray-400 mb-1">Logo URL (light mode)</label>
            <input value={identity.logo_url ?? ""} onChange={e => set("logo_url", e.target.value || null)}
              className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-sm text-white focus:border-indigo-500 focus:outline-none" placeholder="https://..." />
          </div>
          <div>
            <label className="block text-xs text-gray-400 mb-1">Logo URL (dark mode)</label>
          ...
          <div className="flex gap-4">
            ...
            {identity.logo_dark_url && (
              <div className="bg-gray-900 border border-gray-700 rounded-lg p-2">
                <img src={identity.logo_dark_url} alt="Logo dark preview" style={{ width: identity.logo_width ?? 160 }} className="h-10 object-contain" />
              </div>
            )}
          </div>
        )}

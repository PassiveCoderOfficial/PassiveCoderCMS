...
import { Globe, DollarSign, TrendingUp, Copy } from "lucide-react";
...
export default async function AgentDashboardPage() {
  ...
  const stats = [
    { label: "Sites Referred", value: siteCount, icon: Globe, color: "text-blue-600 bg-blue-50 dark:bg-blue-900/20" },
    ...
    <div className="p-6 space-y-6 max-w-4xl">
      ...
      <div className="rounded-xl border bg-card p-4 space-y-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <a
            href={`/api/agent/copy-referral?code=${agent.referral_code}`}
            className="flex items-center gap-1.5 text-xs bg-primary text-primary-foreground px-3 py-2 rounded-lg font-medium hover:bg-primary/90 transition-colors"
          >

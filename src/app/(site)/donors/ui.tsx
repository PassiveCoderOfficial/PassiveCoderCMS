...
export const inputCls =
  "w-full border rounded-lg px-3 py-2.5 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-red-500/30";
export const btnCls =
...
export const btnGhostCls =
  "w-full flex items-center justify-center gap-2 border rounded-lg px-4 py-2.5 text-sm font-medium hover:bg-gray-50 transition-colors";
